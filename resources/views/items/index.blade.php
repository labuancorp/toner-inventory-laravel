                        ...
                        <div class="row g-2 align-items-center mb-3">
                            ...
                            <div class="col-md-9">
                                <form method="GET" class="row g-2 align-items-center">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="q" value="{{ request('q') }}" placeholder="Search all items..." class="form-control" />
                                    </div>
                                </form>
                            </div>
                            {{-- Client-side search for the current page --}}
                            <div class="col-md-3">
                                <input x-model="clientSearch" type="text" placeholder="Filter this page..." class="form-control" />
                            </div>
                        </div>
                            ...
                            <table class="table table-vcenter table-striped">
                                ...
                                <tbody x-ref="tableBody">
                                    @forelse($items as $item)
                                        <tr
                                            x-show="clientSearch === '' || '{{ strtolower($item->name . ' ' . $item->sku) }}'.includes(clientSearch.toLowerCase())"
                                            x-transition
                                        >
                                            <td>
